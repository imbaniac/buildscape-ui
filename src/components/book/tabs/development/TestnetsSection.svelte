...
<div class="testnets-modern" style="--brand-color: {brandColor}">
  {#each testnets as testnet (typeof testnet === "string" ? testnet : testnet.name)}
    {@const testnetInfo =
      typeof testnet === "string" ? { name: testnet } : testnet}
      ...
      {#if testnetInfo.faucets && testnetInfo.faucets.length > 0}
        <div class="testnet-section">
          ...
          <div class="faucet-pills">
            {#each testnetInfo.faucets.slice(0, 4) as faucetUrl (faucetUrl)}
            ...
            {#if testnetInfo.faucets.length > 4}
              <div class="more-faucets">
                <button class="more-btn"
                  >+{testnetInfo.faucets.length - 4} more</button
                >
                <div class="more-menu">
                  {#each testnetInfo.faucets.slice(4) as faucetUrl (faucetUrl)}
      ...
      {#if testnetInfo.rpcs && testnetInfo.rpcs.length > 0}
        <div class="testnet-section">
          ...
          <div class="testnet-rpcs">
            {#each testnetInfo.rpcs as rpcUrl (rpcUrl)}
